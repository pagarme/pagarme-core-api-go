...
![Importing SDK into Eclipse - Step 3](https://apidocs.io/illustration/go?step=import2&workspaceFolder=Pagarme.Core.Api-GoLang&projectName=pagarmecoreapi_lib)
...
![Adding dependency to the client library - Step 3](https://apidocs.io/illustration/go?step=testProject2&workspaceFolder=Pagarme.Core.Api-GoLang)
...
```go
page,_ := strconv.ParseInt("205", 10, 8)
size,_ := strconv.ParseInt("205", 10, 8)
name := "name"
status := "status"
...
```go
subscriptionId := "subscription_id"
page,_ := strconv.ParseInt("163", 10, 8)
size,_ := strconv.ParseInt("163", 10, 8)
name := "name"
code := "code"
status := "status"
...
```go
customerId := "customer_id"
page,_ := strconv.ParseInt("254", 10, 8)
size,_ := strconv.ParseInt("254", 10, 8)
