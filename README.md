...
```go
page,_ := strconv.ParseInt("59", 10, 8)
size,_ := strconv.ParseInt("59", 10, 8)
name := "name"
status := "status"
...
```go
subscriptionId := "subscription_id"
page,_ := strconv.ParseInt("150", 10, 8)
size,_ := strconv.ParseInt("150", 10, 8)
...
size,_ := strconv.ParseInt("242", 10, 8)
status := "status"
timeframe := "timeframe"
